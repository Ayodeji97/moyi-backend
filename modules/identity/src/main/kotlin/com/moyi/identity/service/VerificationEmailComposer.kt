...
internal class VerificationEmailComposer(
    ...
    fun compose(event: VerificationRequested): EmailMessage {
        ...
        return EmailMessage(
            ...
            text =
                ...
                |Hi $name,
                |
                |Confirm this is your address by opening the link below. It works once and expires in 24 hours.
                |
                |$link
                |
                |If you did not create a Moyi account, you can ignore this email — nothing happens without the link.
                """.trimMargin(),
            html =
                """
                |<p>Hi ${HtmlUtils.htmlEscape(name)},</p>
                |<p>Confirm this is your address by opening the link below. It works once and expires in 24 hours.</p>
                |<p><a href="${HtmlUtils.htmlEscape(link)}">Confirm my email</a></p>
                |<p>If you did not create a Moyi account, you can ignore this email — nothing happens without the link.</p>
                """.trimMargin(),
    ...
    private companion object {
        const val SUBJECT = "Confirm your email address"
    }
}
